...
// src/tools/widget/widget-resource.ts from the directory of the compiled module.
...
const ASSETS = [['src/tools/widget/routes-widget.html', 'dist/src/tools/widget/routes-widget.html']];
